...
```
docker tag [hash] ortussolutions/contentbox:5.6.1
docker tag ortussolutions/contentbox:5.6.1 ortussolutions/contentbox:latest
docker tag ortussolutions/contentbox:5.6.1 ortussolutions/contentbox:snapshot
